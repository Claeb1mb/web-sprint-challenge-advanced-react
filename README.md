...
2. Describe the different phases of the component lifecycle.
   Mounting= componentDidMount- called as soon as the render method is called
   Updating= ComponentDidUpdate- New Props, setState() forceUpdate()
   Unmounting= componentWillUnmount- like a trash where old information is going and wont be reused
